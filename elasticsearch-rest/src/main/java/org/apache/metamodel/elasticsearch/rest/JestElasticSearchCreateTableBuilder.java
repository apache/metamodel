...
final class JestElasticSearchCreateTableBuilder extends AbstractTableCreationBuilder<JestElasticSearchUpdateCallback> {
    ...
    public Table execute() throws MetaModelException {
        ...
        if (table.getColumnByName(ElasticSearchRestDataContext.FIELD_ID) == null) {
            final MutableColumn idColumn = new MutableColumn(ElasticSearchRestDataContext.FIELD_ID, ColumnType.STRING)
