 ...
 *
 */
public class CsvDirectoryDataContext extends QueryPostprocessDataContext implements UpdateableDataContext {

    private static final Logger logger = LoggerFactory.getLogger(CsvDirectoryDataContext.class);
     ...
     * @param configuration
     */
    public CsvDirectoryDataContext(File file, CsvConfiguration configuration) {
        if (file == null) {
    ...
    public CsvDirectoryDataContext(Resource resource, CsvConfiguration configuration) {
        if (resource == null) {
            throw new IllegalArgumentException("File cannot be null");
        }
        if (configuration == null) {
     ...
     * @param configuration
     */
    public CsvDirectoryDataContext(URL url, CsvConfiguration configuration) {
     ...
     * @param file
     */
    public CsvDirectoryDataContext(File file) {
     ...
     * @param configuration
     */
    public CsvDirectoryDataContext(InputStream inputStream, CsvConfiguration configuration) {
    ...
    /**
     * @deprecated use {@link #CsvDirectoryDataContext(File, CsvConfiguration)} instead.
     */
    @Deprecated
    public CsvDirectoryDataContext(File file, char separatorChar) {
     ...
     */
    @Deprecated
    public CsvDirectoryDataContext(File file, char separatorChar, char quoteChar) {
     ...
     */
    @Deprecated
    public CsvDirectoryDataContext(File file, char separatorChar, char quoteChar, String encoding) {
    ...
    /**
     * @deprecated use {@link #CsvDirectoryDataContext(URL, CsvConfiguration)} instead.
     */
    @Deprecated
    public CsvDirectoryDataContext(URL url, char separatorChar, char quoteChar) {
     ...
     */
    @Deprecated
    public CsvDirectoryDataContext(URL url, char separatorChar, char quoteChar, String encoding) {
        this(url, new CsvConfiguration(CsvConfiguration.DEFAULT_COLUMN_NAME_LINE, encoding, separatorChar, quoteChar,
                CsvConfiguration.DEFAULT_ESCAPE_CHAR));
    }

    /**
     * @deprecated use {@link #CsvDirectoryDataContext(InputStream, CsvConfiguration)}
     *             instead.
     */
    @Deprecated
    public CsvDirectoryDataContext(InputStream inputStream, char separatorChar, char quoteChar) {
     ...
     */
    @Deprecated
    public CsvDirectoryDataContext(InputStream inputStream, char separatorChar, char quoteChar, String encoding) {
