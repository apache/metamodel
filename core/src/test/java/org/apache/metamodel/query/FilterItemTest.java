...
public class FilterItemTest extends TestCase {
    ...
    /**
     * Tests that the following (general) rules apply to the object: <p/> <li>the hashcode is the same when run twice on
     * an unaltered object</li> <li>if o1.equals(o2) then this condition must be true: o1.hashCode() == 02.hashCode()
     */
