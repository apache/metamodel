...
public class MutableSchemaTest {
    ...
    public void testEqualsAndHashCode() throws Exception {
        final MutableSchema schema1 = new MutableSchema("foo");
        final MutableSchema schema2 = new MutableSchema("foo");
        ...
        final MutableSchema schema3 = new MutableSchema("foo");
        assertTrue(schema1.equals(schema3));
        assertTrue(schema1.hashCode() == schema3.hashCode());
    }
