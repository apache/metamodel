...
final class ConcatSelectBuilderImpl extends SatisfiedSelectBuilderImpl implements
    ...
    public ConcatSelectBuilderImpl(Column column, FunctionType functionType,Object[] functionParameters,
                                   Query query, GroupedQueryBuilder queryBuilder) {
        super(queryBuilder);

        this.selectItem = new SelectItem(column, functionType, functionParameters);
