...
public class XmlDomDataContextTest extends TestCase {
	...
	public void testGetSchemas() throws Exception {
		...
		assertEquals("xml_input_eobjects.xml", dataContext.getDefaultSchema()
				.getName());
		...
		assertEquals(
				"[Table[name=eobjects.dk,type=TABLE,remarks=null], "
		...
		assertEquals(
				"[Column[name=id,columnNumber=0,type=INTEGER,nullable=false,nativeType=Auto-generated primary key,columnSize=null], "
						+ "Column[name=website,columnNumber=2,type=VARCHAR,nullable=true,nativeType=XML Attribute,columnSize=null]]",
		...
		assertEquals(
				"[Column[name=id,columnNumber=0,type=INTEGER,nullable=false,nativeType=Auto-generated primary key,columnSize=null], "
						...
						+ "Column[name=name,columnNumber=2,type=VARCHAR,nullable=true,nativeType=XML Text,columnSize=null]]",
				Arrays.toString(table.getColumns()));
		assertEquals(
				"[Relationship[primaryTable=contributors_person,primaryColumns=[id],"
		...
		assertEquals(
				"[Column[name=id,columnNumber=0,type=INTEGER,nullable=false,nativeType=Auto-generated primary key,columnSize=null], "
						+ "Column[name=contributors_person_id,columnNumber=1,type=INTEGER,nullable=false,nativeType=Auto-generated foreign key,columnSize=null], "
						+ "Column[name=address,columnNumber=2,type=VARCHAR,nullable=true,nativeType=XML Text,columnSize=null]]",
				Arrays.toString(table.getColumns()));
		assertEquals(
				"[Relationship[primaryTable=contributors_person,primaryColumns=[id],"
		...
		assertEquals(
				"[Column[name=id,columnNumber=0,type=INTEGER,nullable=false,nativeType=Auto-generated primary key,columnSize=null], "
						+ "Column[name=project,columnNumber=1,type=VARCHAR,nullable=true,nativeType=XML Text,columnSize=null], "
						+ "Column[name=name,columnNumber=2,type=VARCHAR,nullable=true,nativeType=XML Attribute,columnSize=null]]",
				Arrays.toString(table.getColumns()));
		...
		assertEquals(
				"[Column[name=id,columnNumber=0,type=INTEGER,nullable=false,nativeType=Auto-generated primary key,columnSize=null], "
						+ "Column[name=name,columnNumber=1,type=VARCHAR,nullable=true,nativeType=XML Text,columnSize=null]]",
				Arrays.toString(table.getColumns()));
	}
	...
	public void testGetTextContent() throws Exception {
		...
		Document document = db.parse(new File(
				"src/test/resources/xml_input_simple.xml"));
		Element rootElement = document.getDocumentElement();
		Element[] childElements = XmlDomDataContext
		...
		assertEquals(
				"[Column[name=id,columnNumber=0,type=INTEGER,nullable=false,nativeType=Auto-generated primary key,columnSize=null], "
						+ "Column[name=child,columnNumber=1,type=VARCHAR,nullable=true,nativeType=XML Text,columnSize=null]]",
				Arrays.toString(table.getColumns()));
	}
	...
	public void testFlattenTables() throws Exception {
		...
		List<Object[]> dependencyData = dc.materializeMainSchemaTable(
				dependencyTable, dependencyTable.getColumns(), -1)
				.toObjectArrays();
		...
		assertEquals(
				"[Column[name=id,columnNumber=0,type=INTEGER,nullable=false,nativeType=Auto-generated primary key,columnSize=null], "
						+ "Column[name=groupId,columnNumber=1,type=VARCHAR,nullable=true,nativeType=XML Text,columnSize=null]]",
				Arrays.toString(dependencyTable.getColumns()));
		...
		assertEquals(
				"[Column[name=id,columnNumber=0,type=INTEGER,nullable=false,nativeType=Auto-generated primary key,columnSize=null], "
						+ "Column[name=groupId,columnNumber=1,type=VARCHAR,nullable=true,nativeType=XML Text,columnSize=null], "
						+ "Column[name=artifactId,columnNumber=2,type=VARCHAR,nullable=true,nativeType=XML Text,columnSize=null], "
						+ "Column[name=version,columnNumber=3,type=VARCHAR,nullable=true,nativeType=XML Text,columnSize=null], "
						+ "Column[name=scope,columnNumber=4,type=VARCHAR,nullable=true,nativeType=XML Text,columnSize=null]]",
				Arrays.toString(dependencyTable.getColumns()));

		dependencyData = dc.materializeMainSchemaTable(dependencyTable,
				dependencyTable.getColumns(), -1).toObjectArrays();
		assertEquals(11, dependencyData.size());
		assertEquals("[1, joda-time, joda-time, 1.5.2, compile]",
				Arrays.toString(dependencyData.get(0)));
		assertEquals("[11, mysql, mysql-connector-java, 5.1.6, test]",
				Arrays.toString(dependencyData.get(10)));
	}

	public void testParsePom() throws Exception {
		XmlDomDataContext dc = new XmlDomDataContext(new File(
				"src/test/resources/xml_input_pom.xml"));
		Schema schema = dc.getDefaultSchema();
		...
		assertEquals(
				"[Column[name=id,columnNumber=0,type=INTEGER,nullable=false,nativeType=Auto-generated primary key,columnSize=null], "
						+ "Column[name=inceptionYear,columnNumber=1,type=VARCHAR,nullable=true,nativeType=XML Text,columnSize=null]]",
				Arrays.toString(table.getColumns()));

		// first read
		DataSet data = dc.executeQuery(new Query()
				.select(table.getColumnByName("inceptionYear")).from(table)
				.setMaxRows(1));
	...
	public void testAutoflattenTicket229() throws Exception {
		...
		assertEquals(
				...
				Arrays.toString(schema.getTableByName("Machine")
						.getColumnNames()));
	}
}